...
window.onload = function() {
    ...
    document.removeEventListener("DOMContentLoaded", arguments.callee, !1), pageload()
}, !1) : document.attachEvent && document.attachEvent("onreadystatechange", function() {
    "complete" === document.readyState && (document.detachEvent("onreadystatechange", arguments.callee), pageload())
});